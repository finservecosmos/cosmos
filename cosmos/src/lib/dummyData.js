...
export const dummyClients = [
  { 
    ...
    drive_link: 'https://drive.google.com/drive/folders/rajesh_docs',
    loan_type: 'Home Loan', 
    amount: 2500000, 
    status: 'Approved', 
    file_no: '#8821', 
    date: '2023-10-15', 
    associate: 'Meena Sharma', 
    employment_status: 'Salaried', 
    monthly_net_income: 125000, 
    co_applicant_income: 85000,
    dwelling_status: 'Owned', 
    tenure_at_address: 5,
    extended_data: {
      co_applicate_name: 'Sunita Kumar',
      ...
      manager_mobile: '9876500000',
      property_value: '8500000',
      banker_name: 'HDFC Bank, Andheri',
      bank_manager_name: 'Vikram Singh',
      bank_manager_number: '9876511111',
      cibil_applicant: '780',
      cibil_co_applicant: '750',
      applicant_total_loans: '1 (Car Loan)',
      co_applicant_total_loans: '0',
      applicant_cibil_briefing: 'Excellent repayment history, no defaults.',
      co_applicant_cibil_briefing: 'Good credit score, low credit utilization.',
      document_issues: 'None',
      business_issues: 'None',
      family_issues: 'None',
      convert_notes: 'Client is ready for immediate disbursement upon final verification.',
      associate_amount: '12500'
    }
  },
